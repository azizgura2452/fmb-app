  ...
  return (
    <ScrollView>
      <Surface style={{ padding: 20, paddingTop: 50 }}>
        <Text variant="headlineSmall" style={customStyles.quote}>
          Huzur-e-Aala TUS stated in one of his Bayaan Mubarak
        </Text>
        <Image
      ...
      <Surface style={[styles.screen]}>
        <Card style={styles.cardContainer}>
          <Card.Content>
            <Text variant="bodySmall" style={customStyles.date}>
              Salawaat/Zabihat Request Form
            </Text>
            <Button
            ...
            <View style={customStyles.tabContainer}>
              <TouchableOpacity
                onPress={() => setActiveTab('Salawaat')}
                style={[
                  customStyles.tabButton,
                  activeTab === 'Salawaat' && customStyles.activeTab,
                ]}
              >
                <Text style={customStyles.tabText}>Salawaat</Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => setActiveTab('Zabihat')}
                style={[
                  customStyles.tabButton,
                  activeTab === 'Zabihat' && customStyles.activeTab,
                ]}
              >
            ...
            {activeTab === 'Salawaat' && (
              <ContributionList refetch={refetch} type="SALAWAAT" />
            )}
            {activeTab === 'Zabihat' && (
              <ContributionList refetch={refetch} type="ZABIHAT" />
            )}
          </Card.Content>
        </Card>
      </Surface>
