...
const Colors = {
  light: {
    ...
    gold: {
      primary: 'rgb(185, 128, 39)',  // #b98027
      onPrimary: 'rgb(255, 255, 255)',  // white for contrast
      primaryContainer: 'rgb(255, 233, 199)',  // lightened version of primary
      onPrimaryContainer: 'rgb(73, 40, 0)',  // dark contrasting color
      secondary: 'rgb(186, 107, 37)',  // slightly darker gold
      onSecondary: 'rgb(255, 255, 255)',  // white for contrast
      secondaryContainer: 'rgb(255, 226, 199)',  // lighter secondary
      onSecondaryContainer: 'rgb(76, 42, 0)',  // darker contrasting color
      tertiary: 'rgb(120, 98, 47)',  // muted yellow-brown for tertiary
      onTertiary: 'rgb(255, 255, 255)',  // white for contrast
      tertiaryContainer: 'rgb(245, 232, 183)',  // lighter tertiary
      onTertiaryContainer: 'rgb(44, 31, 0)',  // dark contrasting color
      background: 'rgb(255, 251, 245)',  // off-white background
      onBackground: 'rgb(32, 26, 24)',  // dark brown text
      surface: 'rgb(255, 251, 245)',  // off-white surface
      onSurface: 'rgb(32, 26, 24)',  // dark brown text
      surfaceVariant: 'rgb(245, 230, 213)',  // light tan for surface variant
      onSurfaceVariant: 'rgb(85, 69, 61)',  // medium brown text
      outline: 'rgb(140, 116, 96)',  // muted brown outline
      outlineVariant: 'rgb(217, 196, 176)',  // lighter outline variant
      shadow: 'rgb(0, 0, 0)',  // default black shadow
      scrim: 'rgb(0, 0, 0)',  // scrim color
      inverseSurface: 'rgb(54, 47, 42)',  // dark surface for inverses
      inverseOnSurface: 'rgb(251, 239, 229)',  // off-white inverse text
      inversePrimary: 'rgb(255, 196, 143)',  // inverted lighter gold
      elevation: {
        level0: 'transparent',  // no color for level 0 elevation
        level1: 'rgb(250, 242, 230)',  // light tan
        level2: 'rgb(247, 236, 220)',  // slightly darker tan
        level3: 'rgb(244, 231, 213)',  // medium tan
        level4: 'rgb(243, 229, 209)',  // darker tan
        level5: 'rgb(241, 225, 201)',  // even darker tan
      },
      surfaceDisabled: 'rgba(32, 26, 24, 0.12)',  // slightly transparent brown
      onSurfaceDisabled: 'rgba(32, 26, 24, 0.38)',  // more transparent brown
      backdrop: 'rgba(60, 45, 30, 0.4)',  // semi-transparent brown backdrop
      success: 'rgb(94 186 0)',
      error: '#F44336'
    },    
  },
  dark: {
